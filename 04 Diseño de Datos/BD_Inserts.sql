...
insert into tipoactividades values(1, 'Masajes');
insert into tipoactividades values(2, 'Inyeccion');
insert into tipoactividades values(3, 'Compañia');
insert into tipoactividades values(4, 'Aseado');
insert into tipoactividades values(5, 'Traslado del paciente');
insert into tipoactividades values(6, 'Fisioterapia Respiratoria');
insert into tipoactividades values(7, 'Medicion de Constantes Vitales');
insert into tipoactividades values(8, 'Alimentacion');
insert into tipoactividades values(9, 'Aerosolterapia');
insert into tipoactividades values(10, 'Oxigenoterapia');
insert into tipoactividades values(11, 'Realizar tendido de cama');
insert into tipoactividades values(12, 'Mecánica Corporal');
insert into tipoactividades values(13, 'Aplicacion de frio');
insert into tipoactividades values(14, 'Aplicacion de calor');
insert into tipoactividades values(15, 'Otros');

insert into actividades values(1, '', 'Masajes en el cuerpo', 1, 1);
insert into actividades values(2, '', 'Hacerle compañia al paciente', 2, 3);
insert into actividades values(3, '', 'Bañado del paciente', 3, 4);
insert into actividades values(4, '', 'Aplicar Inyecciones correspondientes', 4, 2);
insert into actividades values(5, '', 'Traslado del paciente al centro de salud', 5, 5);
insert into actividades values(6, '', 'El paciente es trasladado a su casa', 6, 5);
insert into actividades values(7, '', 'Se realiza fisioterapia al paciente', 7, 6);
insert into actividades values(8, '', 'Otro tipo de actividad', 8, 15);
insert into actividades values(9, '', 'Control de los signos vitales del paciente', 9, 7);
insert into actividades values(10, '', 'Aplicar las inyecciones al paciente', 10, 2);
insert into actividades values(11, '', 'Se necesita que se bañe al cliente', 11, 4);
insert into actividades values(12, '', 'Alimentacion del cliente durante la tarde', 12, 8);
insert into actividades values(13, '', 'El paciente requiere de compañia del enfermero', 13, 3);
insert into actividades values(14, '', 'Oxigenoterapia al paciente', 14, 10);
insert into actividades values(15, '', 'Se requiere el tendido de cama del paciente', 15, 11);
insert into actividades values(16, '', 'Aerosolterapia al paciente', 16, 9);
insert into actividades values(17, '', 'Ejercicios psicomotrices de mecanica corporal', 17, 12);
insert into actividades values(18, '', 'Terapia de aplicacion de calor al cliente', 18, 14);
insert into actividades values(19, '', 'Terapia de aplicacion de frio al cliente', 19, 13);
insert into actividades values(20, '', 'Masajes en el torso', 20, 1);
